...
/**
 *  \file       core/modules/cleaningservice/doc/pdf_standard.modules.php
...
/**
 *	Class to manage PDF template standard_cleaningservicetask
 */
class pdf_standard_cleaningservicetask extends ModelePDFCleaningServiceTask
{
	/**
	 ...
	 *
	 *  @param		CleaningServiceTask	$object				Object to generate
	 ...
	 *
	 *  @param	TCPDF		$pdf     		Object PDF
	 *  @param  CleaningServiceTask	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('CLEANINGSERVICE_DRAFT_WATERMARK') && $object->statut == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('CLEANINGSERVICE_DRAFT_WATERMARK')));
		}
